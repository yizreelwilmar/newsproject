...
<nav class="navbar navbar-light navbar-expand-lg navbar-light bg-light fixed-top home">
   <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand d-flex w-50 mr-auto">
         <!-- deklarasi brand untuk frontend yizreel 20/08 -->
         <img src="<?= base_url('') ?>" alt="Yiz_dev Brand">
      </a>
      ...
      <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
         ...
         <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
            ...
            <li class="nav-item">
               <a class="nav-link" href="<?= base_url("back/posting/create_guest") ?>">
                  <i class="fa fa-book"></i> Post Your News
               </a>
            </li>
         </ul>
      </div>
